    ...
    return (
        <div className="features_main">
            <div className="features_main_1">
                ...
                <FeaturesComponent id_a='feature_text_id_2' href='/places10' text="Uniqueness in Simplicity !" id_b='feature_img_2' src='./images/img_1.jpeg'/>
            </div>
            ...
            <div className="features_main_2">
                ...
                <FeaturesComponent id_a='feature_text_id_2' href='/stores' text="Best stores around the city !" id_b='feature_img_2' src='./images/img_1.jpeg'/> 
            </div>
        </div>
    );
}
